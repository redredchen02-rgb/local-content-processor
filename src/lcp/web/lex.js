...
const LEX = {
  "state": {
    ...
    "blocked": {"title": "风险封锁·终止", "glyph": "✕", "why": "命中红线（如未成年、隐私、重大风险），不可发布。", "next": "不能放行；此为终点，仅供检视。", "tone": "stop"},
    "duplicate": {"title": "重复·终止", "glyph": "✕", "why": "与既有内容重复，不应再发。", "next": "此为终点，仅供检视。查重仅代表本工具处理过、非全站。", "tone": "stop"},
  ...
  "honesty": {
    ...
    "dewatermark_attest": "去水印仅限自有／授权素材。这是具结非证明：系统不核验授权，独立复核者需不同于提交人，原始依据不上链（仅存哈希）。"
  },
  "dashboard": {
    "title": "累积总览",
